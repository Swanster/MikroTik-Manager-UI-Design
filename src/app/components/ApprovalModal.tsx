      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ fontFamily: "'Inter', sans-serif", fontWeight: 600, fontSize: 16 }} className="text-t-text">
              Command Approval
            </span>
            <span
              style={{
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                  <span
                    style={{
                      ...
                      padding: '2px 6px',
                      borderRadius: 4,
                      background: riskBg(cmd.risk),
                      color: riskColor(cmd.risk),
                    }}
                  >
                    {cmd.risk}
                  </span>
                ...
                <div
                  ...
                  className="text-t-text bg-t-surface2 border border-t-border"
                >
                  {cmd.command}
                </div>
              </div>
        ...
        >
          <span style={{ fontSize: 12 }} className="text-t-text-subtle">
            {selected.size} of {commands.length} selected
          </span>
          <div style={{ display: 'flex', gap: 8 }}>
            <button
              onClick={() => {
                onReject(commands.map((c) => c.id));
                onClose();
              }}
              style={{
                borderRadius: 8,
