    ...
    const handler = (e: KeyboardEvent) => {
      ...
      switch (e.key) {
        ...
        case "l":
          ...
          break;
        case "c":
          if (!e.ctrlKey && !e.metaKey) { e.preventDefault(); setActiveNav("config"); }
          break;
        case "t":
          if (!e.ctrlKey && !e.metaKey) { e.preventDefault(); setActiveNav("troubleshoot"); }
          break;
        case "s":
          if (!e.ctrlKey && !e.metaKey) { e.preventDefault(); setActiveNav("devices"); }
          break;
        case "r":
          if (!e.ctrlKey && !e.metaKey && onRefresh) { e.preventDefault(); onRefresh(); }
          break;
        case "Escape":
